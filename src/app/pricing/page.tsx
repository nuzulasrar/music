...
const page: FC = () => {
  ...
  const complexity_lists = [
    {
      id: 1,
      name: "<b>Simple.</b> 1-5 Screens. 0-3 Application Modules.",
      price: 4000,
    },
    {
      id: 2,
      name: "<b>Medium.</b> 6-10 Screens. 4-5 Application Modules.",
      price: 8500,
    },
    {
      id: 3,
      name: "<b>Complex.</b> 10-15 Screens. Above 15 Screens are charged per screen. 5 or more Application Modules. ",
      price: 14000,
    },
  ];
  ...
  const module_lists = [
    {
      id: 1,
      name: "Account Registration & Authentication (Sign Up / Sign In)",
      description: "",
      price: 1000,
    },
    ...
    {
      id: 9,
      name: "Generate Reports - PDF / Files",
      description: "",
      price: 800,
    },
    {
      id: 10,
      name: "View/Add/Edit/Delete Information",
      description: "",
      price: 500,
    },
    {
      id: 11,
      name: "User Visual Customization (eg: theme color)",
      description: "",
      price: 800,
    },
  ...
  useEffect(() => {
    ...
    const index = complexity_lists.findIndex(
      (item) => item.id === selectedComplexity
    );
    ...
    <div className="flex flex-row">
      ...
      <div
        ...
        className={`bg-cover bg-no-repeat min-h-screen ${
          !opensidebar ? "sm:w-1/12" : "sm:w-1/3 lg:w-1/6 px-[16px] py-4"
        } bg-black border-r border-cyan-500`}
      >
        <div className="flex flex-row justify-between mb-[20px]">
          <h1
            className={`text-[2.6vh] font-bold`}
            style={{ color: `#${theme}` }}
          >
            Fuser
          </h1>
        ...
        {/* Menu */}
        <h2 className="text-white mb-[5px] text-lg font-semibold">
          Front End Code Builder
        </h2>
        <div className="backdrop-opacity-10 backdrop-invert bg-black/10 p-4 rounded-xl">
          <p className={`font-bold`} style={{ color: `#${theme}` }}>
            Network Request
          </p>
          <p
            className={`text-white font-[400] bg-[#${theme}] px-2 py-1 mt-1 rounded-md`}
          >
            <Link href={"/builder/fetch"}>. Fetch</Link>
          </p>
          <p className="text-white font-[400]">
            <Link href={"/builder/axios"}>. Axios</Link>
          </p>

          <p className={`font-bold mt-3`} style={{ color: `#${theme}` }}>
      ...
      >
        ...
        >
          ...
          <div className="flex mb-[10px] px-8">
            {/* <h1
              className={`text-white dark:text-slate-900 px-4 py-2 rounded-lg font-semibold text-[2.1vh] text-left`}
              style={{ backgroundColor: `#${theme}` }}
            >
              Price Calculator
            </h1> */}
            <button
              className={`text-white border-l-[6px] border-l-slate-600 dark:text-slate-900 px-6 py-3 bg-gray-200 rounded-0 font-semibold hover:scale-105 mt-3`}
              style={{
          ...
          <div className=" rounded-[7px] border-white py-5 px-4 m-3">
            {/* Switch */}
            ...
            <div className="lg:flex lg:flex-row">
              ...
              <div className="sm: w-full lg:w-2/3 lg:mx-2 backdrop-opacity-10 backdrop-invert bg-white/100 dark:bg-white/10 rounded-lg pt-4 pb-6 px-4 mb-5">
                <h3 className="text-black dark:text-white font-semibold text-[1.8vh] mb-[8px]">
                  Application Modules{" "}
                  <span
                    className="px-3 py-1 text-white rounded-xl text-[12px]"
                    style={{
                      backgroundColor: `#${theme}`,
                    }}
                  >
                      ...
                      <button
                        ...
                        className={`${
                          selectedModules.includes(item.id)
                            ? "text-white border-l-[6px] border-l-slate-600"
                            : "text-black"
                        } dark:text-slate-900 px-6 py-3 bg-gray-200 rounded-0 font-semibold hover:scale-105 mt-3`}
                        style={{
                          // backgroundColor: selectedModules.includes(item.id) ? `#${theme}` : "white",
                          // borderColor: `#${theme}`
                          // borderColor: selectedModules.includes(item.id) ? `#${theme}` : `rgb(107 114 128)`,
                          // borderWidth: selectedModules.includes(item.id) ? 0 : 0,
                          backgroundColor: selectedModules.includes(item.id)
                            ? `#${theme}`
                            : "rgb(229 231 235)",
                          clipPath:
                            "polygon(0 0, 100% 0, 100% 50%, 90% 100%, 0 100%)",
                        }}
                      >
                        {item.name}
                      </button>
              ...
              <div
                draggable
                className="sm:w-full lg:w-1/3 lg:mx-2 backdrop-opacity-10 backdrop-invert bg-white/100 dark:bg-white/10 rounded-lg pt-4 pb-6 px-4 mb-5"
              >
                <h3 className="text-black dark:text-white font-semibold text-[1.8vh] mb-[8px]">
                      ...
                      <button
                        ...
                        onClick={() => {
                          ...
                          if (item.id === 1) {
                            if (selectedModules.length > 3) {
                              alert(
                                "More than 3 Modules are selected. It is a Medium or Complex application."
                              );
                            } else {
                            ...
                            if (selectedModules.length > 5) {
                              alert(
                                "More than 5 Modules are selected. It is a Complex application."
                              );
                            } else {
                              setSelectedComplexity(item.id);
                            }
                        ...
                        className={`${
                          selectedComplexity == item.id
                            ? "text-white border-l-[6px] border-l-slate-600"
                            : "text-black"
                        } dark:text-slate-900 px-6 py-3 rounded-0 font-semibold hover:scale-105 mt-3`}
                        style={{
                          backgroundColor:
                            selectedComplexity === item.id
                              ? `#${theme}`
                              : "rgb(229 231 235)",
                          clipPath:
                            "polygon(0 0, 100% 0, 100% 50%, 95% 100%, 0 100%)",
                        }}
                      >
            ...
            <div className="lg:flex lg:flex-row">
              ...
              <div className="sm:w-full lg:w-2/3 lg:mx-2 backdrop-opacity-10 backdrop-invert bg-white/100 dark:bg-white/10 rounded-lg pt-4 pb-6 px-4 mb-5">
                ...
                />
                <p className="text-black font-bold text-[2vh]">
                  {duration} Months of development +{" "}
                  {duration < 10 ? "1 Month" : "2 Months"} of testing.
                </p>
              </div>
              ...
              <div className="sm: w-full lg:w-1/3 lg:mx-2 backdrop-opacity-10 backdrop-invert bg-white/100 dark:bg-white/10 rounded-lg pt-4 pb-6 px-4 mb-5">
                ...
                <input
                  type="text"
                  className="font-semibold bg-gray-200 dark:bg-white/90 pl-2 w-full rounded-lg h-[35px]"
                  value={endpoint}
              ...
              <div className="sm:w-full lg:w-2/3 lg:mx-2 backdrop-opacity-10 backdrop-invert bg-white/100 dark:bg-white/10 rounded-lg pt-4 pb-6 px-4 mb-5">
                ...
                <div className="py-2 flex flex-row">
                  <input
                    type="checkbox"
                    className="mr-2"
                    checked={showDevice ? true : false}
                    onChange={(e) => setShowDevice(!showDevice)}
                  />
                  <p className="text-[16px]">Show Device Frame</p>
                </div>
                <div className="flex flex-wrap justify-start sm:space-x-2 md:space-x-3 mt-5">
                  ...
                  <div className="flex flex-wrap justify-center items-center xl:hover:scale-110 mb-3">
                    <div
                      ...
                      style={{ height: 425, width: 250 }}
                    >
                      <div
                        className="rounded-[22px] relative flex flex-col justify-start items-center shadow-[0_3px_10px_rgb(0,0,0,0.2)]"
                        style={{
                          height: 425,
                          width: 200,
                          backgroundColor: `#${theme}`,
                      ...
                      >
                        <p className="text-black font-semibold text-[10px] absolute top-[6px] left-[19px] z-2">
                          12:00
                        </p>
                        <Image
                          alt=""
                        ...
                        />
                        <div
                          className="bg-white rounded-t-[20%] rounded-b-[22px] absolute bottom-0 h-48 flex flex-col justify-start items-center"
                          style={{ width: 200 }}
                        >
                          <p className="text-[14px] font-semibold justify-self-end text-end mt-4 -ml-20">
                            Username
                          </p>
                          <input
                            type="text"
                            className="bg-gray-200 w-36 h-5 rounded-[5px] mb-0.5"
                          />
                          <p className="text-[14px] font-semibold justify-self-end text-end -ml-20">
                            Password
                          </p>
                          <input
                            type="text"
                            className="bg-gray-200 w-36 h-5 rounded-[5px] mb-4"
                          />

                          <button
                            className="rounded-md bg-white w-36 py-1 shadow-sm shadow-gray-600 mb-2"
                            style={{ backgroundColor: `#${theme}` }}
                          >
                  ...
                  <div className="flex flex-wrap justify-center items-center xl:hover:scale-110 mb-3">
                    ...
                    >
                      <div
                        className="rounded-[22px] relative flex flex-col shadow-[0_3px_10px_rgb(0,0,0,0.2)]"
                        style={{
                          height: 425,
                          width: 200,
                          backgroundColor: `#${theme}`,
                      ...
                      >
                        ...
                        <div
                          className="bg-[rgba(255,255,255,0.95)] rounded-t-[22px] rounded-b-[50px] absolute top-0 w-full h-40"
                          style={{ zIndex: 1 }}
                        >
                          <p className="text-black font-semibold text-[10px] absolute top-[6px] left-[19px] z-2">
                            12:00
                        ...
                        <div className="flex flex-row py-2 overflow-x-auto no-scrollbar px-2 z-20">
                          <div className="px-0.5">
                            <div className="bg-[rgba(255,255,255,0.95)] rounded-lg w-28 px-1.5 py-1 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                              ...
                              <p className="text-[10px] text-slate-500 leading-[10px] mb-1">
                                Create a new defect checklist.
                              </p>
                            </div>
                          </div>
                          <div className="px-0.5">
                            <div className="bg-[rgba(255,255,255,0.95)] rounded-lg w-28 px-1.5 py-1 shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                              ...
                              <p className="text-[10px] text-slate-500 leading-[10px] mb-1">
                                Monitor all hardware status.{" "}
                                <span className="invisible">sdsad</span>
                              </p>
                            </div>
                          </div>
                          <div className="px-0.5">
                        ...
                        <div className="px-2.5">
                          <div className="bg-[rgba(255,255,255,0.95)] w-full px-2 py-2 rounded-lg shadow-[0_3px_10px_rgb(0,0,0,0.2)]">
                            ...
                            <div className="w-full flex flex-row justify-between items-center">
                              ...
                              <p className="text-[9px] font-semibold text-white mb-1 bg-green-500 px-1.5 rounded-lg">
                                Done
                              </p>
                            </div>
                            <div className="w-full flex flex-row justify-between items-center">
                              ...
                              <p className="text-[9px] font-semibold text-white mb-1 bg-teal-500 px-1.5 rounded-lg">
                                Pending
                              </p>
                            </div>
                            <div className="w-full flex flex-row justify-between items-center">
                              ...
                              <p className="text-[9px] font-semibold text-black mb-1 bg-yellow-300 px-1.5 rounded-lg">
                                Canceled
                              </p>
                            </div>
                          </div>
                        ...
                        <div className="bg-white h-10 px-2 w-full absolute bottom-0 rounded-b-[22px] flex flex-row justify-around items-center">
                          <div
                            className="h-4 w-1/4 rounded-md justify-center items-center"
                            style={{}}
                          >
                            <p
                          ...
                          <div
                            className="h-6 w-6 rounded-[50%] flex justify-center items-center"
                            style={{}}
                          >
                            <Image
                              alt=""
            ...
            <div className="w-full lg:mx-2 backdrop-opacity-10 backdrop-invert bg-white/100 dark:bg-black/10 rounded-lg pt-4 pb-6 px-4 mb-5">
              <h3 className="text-black dark:text-white font-semibold text-[1.8vh] text-right mb-[10px]">
                Estimation Cost: {discount}
              </h3>
              <div
                className={`backdrop-opacity-10 backdrop-invert bg-white/100 dark:bg-black/10 px-10 py-5 rounded-md border-2 border-gray-200`}
